 ...
 * Email Service Core
 *
 * Core email sending functionality without queue/subscription dependencies.
 * This file exists to break circular dependencies between index.ts, queue.ts, and subscriptions.ts.
 */
