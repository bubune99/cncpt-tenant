  ...
  api: {
    admin: {
      ...
      roles: {
        ...
        byId: (id: string) => `/api/cms/admin/roles/${id}` as const,
      },
      users: {
        root: "/api/cms/admin/users",
        byId: (id: string) => `/api/cms/admin/users/${id}` as const,
        permissions: (id: string) => `/api/cms/admin/users/${id}/permissions` as const,
        roles: (id: string) => `/api/cms/admin/users/${id}/roles` as const,
      },
      customers: {
        root: "/api/cms/admin/customers",
        byId: (id: string) => `/api/cms/admin/customers/${id}` as const,
        syncStripe: (id: string) => `/api/cms/admin/customers/${id}/sync-stripe` as const,
      },
      siteSettings: {
        root: "/api/cms/admin/site-settings",
        header: "/api/cms/admin/site-settings/header",
        footer: "/api/cms/admin/site-settings/footer",
        announcement: "/api/cms/admin/site-settings/announcement",
      },
      partials: {
        root: "/api/cms/admin/partials",
        byId: (id: string) => `/api/cms/admin/partials/${id}` as const,
        setDefault: (id: string) => `/api/cms/admin/partials/${id}/set-default` as const,
      },
      dashboard: {
        metrics: "/api/cms/admin/dashboard/metrics",
        timeSeries: "/api/cms/admin/dashboard/time-series",
        layout: "/api/cms/admin/dashboard/layout",
      },
      modules: {
        root: "/api/cms/admin/modules",
        presets: "/api/cms/admin/modules/presets",
      },
      auditLog: "/api/cms/admin/audit-log",
      settings: "/api/cms/admin/settings",
    },
    blog: {
      root: "/api/cms/blog",
      bySlug: (slug: string) => `/api/cms/blog/${slug}` as const,
    },
    blogCategories: "/api/cms/blog-categories",
    blogTags: "/api/cms/blog-tags",
    products: {
      root: "/api/cms/products",
      bySlug: (slug: string) => `/api/cms/products/${slug}` as const,
    },
    cart: "/api/cms/cart",
    checkout: "/api/cms/checkout",
    orders: "/api/cms/orders",
    media: "/api/cms/media",
    blockEditorChat: "/api/cms/block-editor-chat",
