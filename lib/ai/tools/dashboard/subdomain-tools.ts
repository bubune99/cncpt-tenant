 ...
 */
export const listSubdomains = tool({
  description:
  ...
  execute: async ({ includeStats }, { userId }) => {
    if (!userId) {
    ...
    try {
      ...
      if (includeStats) {
        // Get domain counts for each subdomain
 ...
 */
export const getSubdomainDetails = tool({
  description:
  ...
  execute: async ({ subdomain }, { userId }) => {
    if (!userId) {
      return { error: "User not authenticated" }
    }

    try {
      // Get subdomain basic info
 ...
 */
export const searchSubdomains = tool({
  ...
  execute: async ({ query }, { userId }) => {
    ...
    try {
      ...
      // Search team-accessible subdomains
 ...
 */
export const getSubdomainStats = tool({
  ...
  execute: async (_, { userId }) => {
    ...
    try {
      ...
      // Count team-accessible subdomains
