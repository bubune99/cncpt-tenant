-- Ensure tenant tables exist before subdomain creation
-- This script should be run before using subdomain functionality

-- First ensure subdomains table has an id column
