 ...
 *
 * PUT /api/events/[id]/ticket-types/[ticketId] - Update a ticket type (tenant-scoped)
 * DELETE /api/events/[id]/ticket-types/[ticketId] - Delete a ticket type (tenant-scoped)
 */
