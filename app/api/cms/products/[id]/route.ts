 ...
 * Single Product API
 *
 * GET /api/products/[id] - Get product by ID (tenant-scoped)
 * PUT /api/products/[id] - Update product (tenant-scoped)
 * DELETE /api/products/[id] - Delete/archive product (tenant-scoped)
 */
