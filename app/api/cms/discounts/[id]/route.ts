 ...
 *
 * GET    /api/discounts/:id - Get discount details (tenant-scoped)
 * PATCH  /api/discounts/:id - Update discount (tenant-scoped)
 * DELETE /api/discounts/:id - Delete discount (tenant-scoped)
 */
...
export async function PATCH(request: NextRequest, { params }: RouteParams) {
  return withTenantAuth(request, 'edit', async () => {
    try {
      ...
      // If changing code, check for duplicates within this tenant
