...
import { useEffect as useEffect2, useRef as useRef2, useState, useCallback, useMemo } from "react";
    ...
    (set, get) => ({
      ...
      updateMessage: (id, updates) => set((state) => ({
        messages: state.messages.map(
          (msg) => msg.id === id ? __spreadValues(__spreadValues({}, msg), updates) : msg
        )
      })),
      ...
      addToHistory: (conversation) => set((state) => {
        ...
        return {
          conversationHistory: [
            __spreadProps(__spreadValues({}, conversation), { updatedAt: /* @__PURE__ */ new Date() }),
            ...filtered
          ].slice(0, 50)
...
function useAutoChatContext() {
  ...
  useEffect(() => {
    const fetchTitle = async () => {
      ...
      if (title) {
        setContext(__spreadProps(__spreadValues({}, context), {
          title
        }));
      }
    };
...
var TypingDots = () => /* @__PURE__ */ jsx3("div", { className: "flex items-center gap-1", children: [0, 1, 2].map((i) => /* @__PURE__ */ jsx3(
  motion.span,
  {
...
function ChatPanel() {
  ...
  if (mode === "collapsed") {
    return /* @__PURE__ */ jsxs2(
      motion.div,
      {
        ...
        children: [
          /* @__PURE__ */ jsx3(TooltipProvider, { children: /* @__PURE__ */ jsxs2(Tooltip, { children: [
            /* @__PURE__ */ jsx3(TooltipTrigger, { asChild: true, children: /* @__PURE__ */ jsx3(
              Button,
              {
                ...
                children: /* @__PURE__ */ jsx3(Sparkles, { className: "h-6 w-6" })
              }
            ) }),
            /* @__PURE__ */ jsx3(TooltipContent, { side: "left", children: /* @__PURE__ */ jsx3("p", { children: "Open AI Assistant" }) })
          ] }) }),
          /* @__PURE__ */ jsx3("span", { className: "absolute inset-0 -z-10 rounded-full bg-primary/20 animate-ping" })
        ]
      }
    );
  }
  ...
  return /* @__PURE__ */ jsxs2(
    motion.div,
    {
      ...
      children: [
        /* @__PURE__ */ jsxs2("div", { className: "flex items-center justify-between px-4 py-3 border-b bg-gradient-to-r from-muted/50 to-transparent", children: [
          /* @__PURE__ */ jsxs2("div", { className: "flex items-center gap-3", children: [
            /* @__PURE__ */ jsx3("div", { className: "flex size-9 items-center justify-center rounded-xl bg-gradient-to-br from-primary/20 to-primary/5 ring-1 ring-primary/20", children: /* @__PURE__ */ jsx3(Sparkles, { className: "h-4 w-4 text-primary" }) }),
            /* @__PURE__ */ jsxs2("div", { className: "flex flex-col", children: [
              /* @__PURE__ */ jsx3("span", { className: "font-semibold text-sm", children: "AI Assistant" }),
              context.type !== "general" && /* @__PURE__ */ jsxs2("span", { className: "text-xs text-muted-foreground capitalize", children: [
                context.type,
                ": ",
          ...
          /* @__PURE__ */ jsx3("div", { className: "flex items-center gap-0.5", children: /* @__PURE__ */ jsxs2(TooltipProvider, { children: [
            /* @__PURE__ */ jsxs2(Tooltip, { children: [
              /* @__PURE__ */ jsx3(TooltipTrigger, { asChild: true, children: /* @__PURE__ */ jsx3(
                Button,
                {
                  ...
                  children: /* @__PURE__ */ jsx3(History, { className: "h-4 w-4" })
                }
              ) }),
              /* @__PURE__ */ jsx3(TooltipContent, { children: "Conversation history" })
            ] }),
            /* @__PURE__ */ jsxs2(Tooltip, { children: [
              /* @__PURE__ */ jsx3(TooltipTrigger, { asChild: true, children: /* @__PURE__ */ jsx3(
                Button,
              ...
              /* @__PURE__ */ jsx3(TooltipContent, { children: "New conversation" })
            ] }),
            /* @__PURE__ */ jsxs2(Tooltip, { children: [
              /* @__PURE__ */ jsx3(TooltipTrigger, { asChild: true, children: /* @__PURE__ */ jsx3(
                Button,
                {
                  ...
                  className: "rounded-lg hover:bg-muted transition-colors h-8 w-8",
                  children: isFullScreen ? /* @__PURE__ */ jsx3(Minimize2, { className: "h-4 w-4" }) : /* @__PURE__ */ jsx3(Maximize2, { className: "h-4 w-4" })
                }
              ) }),
              /* @__PURE__ */ jsx3(TooltipContent, { children: isFullScreen ? "Minimize" : "Maximize" })
            ] }),
            /* @__PURE__ */ jsxs2(Tooltip, { children: [
              /* @__PURE__ */ jsx3(TooltipTrigger, { asChild: true, children: /* @__PURE__ */ jsx3(
                Button,
              ...
              /* @__PURE__ */ jsx3(TooltipContent, { children: "Close" })
            ] })
          ] }) })
        ] }),
        /* @__PURE__ */ jsx3(AnimatePresence, { children: aiError && /* @__PURE__ */ jsx3(
          motion.div,
          {
            ...
            children: /* @__PURE__ */ jsxs2("div", { className: "flex items-center gap-3 px-4 py-3", children: [
              /* @__PURE__ */ jsx3(AlertCircle, { className: "h-4 w-4 text-destructive shrink-0" }),
              /* @__PURE__ */ jsx3("p", { className: "text-sm text-destructive flex-1", children: aiError }),
              aiError.includes("Settings") && /* @__PURE__ */ jsxs2(
                Button,
                {
                  variant: "outline",
                  size: "sm",
                  ...
                  className: "shrink-0",
                  children: [
                    /* @__PURE__ */ jsx3(Settings, { className: "h-3 w-3 mr-1" }),
                    "Settings"
                  ]
                }
              )
        ...
        /* @__PURE__ */ jsx3(AnimatePresence, { children: showHistory && /* @__PURE__ */ jsx3(
          motion.div,
          {
            ...
            children: /* @__PURE__ */ jsxs2("div", { className: "p-3", children: [
              /* @__PURE__ */ jsxs2("div", { className: "flex items-center justify-between mb-3", children: [
                /* @__PURE__ */ jsxs2("div", { className: "flex items-center gap-2", children: [
                  /* @__PURE__ */ jsx3(History, { className: "h-4 w-4 text-muted-foreground" }),
                  /* @__PURE__ */ jsx3("span", { className: "text-sm font-medium", children: "Recent Conversations" }),
                ...
                conversationHistory.length > 0 && /* @__PURE__ */ jsx3(TooltipProvider, { children: /* @__PURE__ */ jsxs2(Tooltip, { children: [
                  /* @__PURE__ */ jsx3(TooltipTrigger, { asChild: true, children: /* @__PURE__ */ jsx3(
                    Button,
                    {
                      variant: "ghost",
                      ...
                      children: /* @__PURE__ */ jsx3(Trash2, { className: "h-3 w-3" })
                    }
                  ) }),
                  /* @__PURE__ */ jsx3(TooltipContent, { children: "Clear history" })
                ] }) })
              ] }),
              conversationHistory.length === 0 ? /* @__PURE__ */ jsxs2("div", { className: "text-center py-6 text-muted-foreground", children: [
                /* @__PURE__ */ jsx3(Clock, { className: "h-8 w-8 mx-auto mb-2 opacity-50" }),
                /* @__PURE__ */ jsx3("p", { className: "text-sm", children: "No conversation history yet" }),
                /* @__PURE__ */ jsx3("p", { className: "text-xs mt-1", children: "Start a conversation to see it here" })
              ] }) : /* @__PURE__ */ jsx3(ScrollArea, { className: "max-h-[200px]", children: /* @__PURE__ */ jsx3("div", { className: "space-y-1", children: conversationHistory.map((conv) => {
                const ContextIcon = conv.context ? getContextIcon(conv.context.type) : MessageSquare;
                    ...
                    children: [
                      /* @__PURE__ */ jsx3(
                        "button",
                        {
                          ...
                          children: /* @__PURE__ */ jsxs2("div", { className: "flex items-start gap-2.5", children: [
                            /* @__PURE__ */ jsx3(
                              "div",
                              {
                                className: cn(
                            ...
                            /* @__PURE__ */ jsxs2("div", { className: "flex-1 min-w-0", children: [
                              /* @__PURE__ */ jsxs2("div", { className: "flex items-center gap-2", children: [
                                ...
                                isActive && /* @__PURE__ */ jsx3("span", { className: "text-[10px] bg-primary/10 text-primary px-1.5 py-0.5 rounded-full", children: "Active" })
                              ] }),
                              /* @__PURE__ */ jsx3("p", { className: "text-xs text-muted-foreground truncate mt-0.5", children: conv.lastMessage || "No messages" }),
                              /* @__PURE__ */ jsxs2("div", { className: "flex items-center gap-2 mt-1", children: [
                                conv.context && conv.context.type !== "general" && /* @__PURE__ */ jsxs2("span", { className: "text-[10px] bg-muted px-1.5 py-0.5 rounded capitalize", children: [
                                  conv.context.type,
                                  conv.context.id && `: ${conv.context.id.slice(0, 8)}...`
                                ] }),
                                /* @__PURE__ */ jsx3("span", { className: "text-[10px] text-muted-foreground/70", children: formatRelativeTime(conv.updatedAt) })
                              ] })
                            ] })
                          ] })
                        }
                      ...
                      /* @__PURE__ */ jsx3(TooltipProvider, { children: /* @__PURE__ */ jsxs2(Tooltip, { children: [
                        ...
                        /* @__PURE__ */ jsx3(TooltipContent, { children: "Remove from history" })
                      ] }) })
                    ]
                  },
                  conv.id
        ...
        /* @__PURE__ */ jsx3(ScrollArea, { className: "flex-1 p-4", ref: scrollRef, children: messages.length === 0 ? /* @__PURE__ */ jsxs2(
          motion.div,
          {
            ...
            children: [
              /* @__PURE__ */ jsx3(
                motion.div,
                {
                  ...
                  children: /* @__PURE__ */ jsx3(Sparkles, { className: "h-8 w-8 text-primary" })
                }
              ),
              /* @__PURE__ */ jsx3(
                motion.p,
              ...
              /* @__PURE__ */ jsx3(
                motion.div,
                {
                  ...
                  children: SUGGESTED_ACTIONS.map((action, i) => /* @__PURE__ */ jsx3(
                    motion.div,
                    {
                      ...
                      children: /* @__PURE__ */ jsxs2(
                        Button,
                        {
                          ...
                          children: [
                            /* @__PURE__ */ jsx3("span", { className: "mr-2", children: action.icon }),
                            /* @__PURE__ */ jsx3("span", { className: "truncate text-xs", children: action.label })
                          ]
                        }
                      )
                    },
          ...
          /* @__PURE__ */ jsx3(AnimatePresence, { mode: "popLayout", children: messages.map((message, index) => {
                ...
                children: [
                  /* @__PURE__ */ jsx3(
                    "div",
                    {
                      ...
                      children: message.role === "user" ? /* @__PURE__ */ jsx3(User, { className: "h-4 w-4" }) : /* @__PURE__ */ jsx3(Sparkles, { className: "h-4 w-4 text-primary" })
                    }
                  ),
                  /* @__PURE__ */ jsxs2(
                    "div",
                    {
                      ...
                      children: [
                        reasoningParts.length > 0 && /* @__PURE__ */ jsxs2("div", { className: "text-xs text-muted-foreground bg-muted/30 rounded-lg px-3 py-2 border-l-2 border-primary/30", children: [
                          /* @__PURE__ */ jsxs2("div", { className: "flex items-center gap-1 mb-1 font-medium", children: [
                            /* @__PURE__ */ jsx3(Loader2, { className: "h-3 w-3 animate-spin" }),
                            "Thinking..."
                          ] }),
                          /* @__PURE__ */ jsx3("p", { className: "italic opacity-70", children: reasoningParts.map((p) => p.text).join("") })
                        ] }),
                        toolParts.map((tool, i) => /* @__PURE__ */ jsxs2(
                          motion.div,
                          {
                            initial: { opacity: 0, x: -10 },
                            animate: { opacity: 1, x: 0 },
                            ...
                            children: [
                              /* @__PURE__ */ jsx3(
                                "div",
                                {
                                  ...
                                  children: tool.state === "result" ? /* @__PURE__ */ jsx3(CheckCircle2, { className: "h-3 w-3 text-green-600" }) : /* @__PURE__ */ jsx3(Loader2, { className: "h-3 w-3 animate-spin text-primary" })
                                }
                              ),
                              /* @__PURE__ */ jsx3("span", { className: "font-medium", children: getToolName(tool) }),
                              tool.state === "result" && /* @__PURE__ */ jsx3("span", { className: "text-green-600 ml-auto", children: "Done" }),
                              (tool.state === "call" || tool.state === "partial-call") && /* @__PURE__ */ jsx3("span", { className: "text-muted-foreground ml-auto", children: tool.state === "partial-call" ? "Preparing..." : "Running..." })
                            ]
                          },
                          tool.toolCallId
                        )),
                        textParts.length > 0 && /* @__PURE__ */ jsx3(
                          "div",
                          {
                            className: cn(
                            ...
                            children: message.role === "assistant" ? /* @__PURE__ */ jsx3("div", { className: "prose prose-sm dark:prose-invert max-w-none prose-p:my-1 prose-ul:my-1 prose-ol:my-1 prose-li:my-0.5 prose-headings:my-2 prose-pre:my-2 prose-code:bg-muted prose-code:px-1 prose-code:rounded", children: /* @__PURE__ */ jsx3(ReactMarkdown, { remarkPlugins: [remarkGfm], children: textParts.map((p) => p.text).join("") }) }) : /* @__PURE__ */ jsx3("p", { className: "text-sm whitespace-pre-wrap", children: textParts.map((p) => p.text).join("") })
                          }
                        )
                      ]
                    }
          ...
          /* @__PURE__ */ jsx3(AnimatePresence, { children: isLoading && /* @__PURE__ */ jsxs2(
            motion.div,
            {
              initial: { opacity: 0, y: 10 },
              animate: { opacity: 1, y: 0 },
              ...
              children: [
                /* @__PURE__ */ jsx3(
                  motion.div,
                  {
                    ...
                    children: /* @__PURE__ */ jsx3(Sparkles, { className: "h-4 w-4 text-primary" })
                  }
                ),
                /* @__PURE__ */ jsxs2("div", { className: "bg-muted/50 rounded-2xl rounded-tl-sm px-4 py-3 flex items-center gap-2", children: [
                  /* @__PURE__ */ jsx3(TypingDots, {}),
                  /* @__PURE__ */ jsx3("span", { className: "text-xs text-muted-foreground", children: "Thinking..." })
                ] })
              ]
            }
          ) })
        ] }) }),
        /* @__PURE__ */ jsxs2("div", { className: "p-4 border-t bg-gradient-to-t from-muted/30 to-transparent", children: [
          /* @__PURE__ */ jsxs2(
            motion.div,
            {
              initial: { opacity: 0, y: 10 },
              ...
              children: [
                ...
                /* @__PURE__ */ jsx3(motion.div, { whileHover: { scale: 1.05 }, whileTap: { scale: 0.95 }, children: isStreaming ? /* @__PURE__ */ jsx3(
                  Button,
                  {
                    onClick: handleStop,
                    size: "icon",
                    ...
                    children: /* @__PURE__ */ jsx3(Square, { className: "h-4 w-4 text-destructive" })
                  }
                ) : /* @__PURE__ */ jsx3(
                  Button,
                  {
                    ...
                    children: status === "submitted" ? /* @__PURE__ */ jsx3(Loader2, { className: "h-4 w-4 animate-spin" }) : /* @__PURE__ */ jsx3(Send, { className: "h-4 w-4" })
                  }
                ) })
              ]
            }
          ),
          /* @__PURE__ */ jsx3("p", { className: "text-[10px] text-muted-foreground/50 text-center mt-2", children: "Press Enter to send, Shift+Enter for new line" })
        ] })
      ]
    }
  );
...
//# sourceMappingURL=chunk-Y4Y34FFA.mjs.map