...
declare function HeroSection({ title, subtitle, backgroundImage, backgroundColor, textColor, height, alignment, overlay, overlayOpacity, }: HeroSectionProps): react_jsx_runtime.JSX.Element;
...
declare function TextBlock({ content, size, alignment, maxWidth, padding, }: TextBlockProps): react_jsx_runtime.JSX.Element;
...
declare function ImageBlock({ src, alt, caption, width, rounded, shadow, }: ImageBlockProps): react_jsx_runtime.JSX.Element;
...
declare function ImageGallery({ images, columns, gap, rounded, }: ImageGalleryProps): react_jsx_runtime.JSX.Element;
...
declare function QuoteBlock({ quote, author, authorTitle, style, }: QuoteBlockProps): react_jsx_runtime.JSX.Element;
...
declare function CTASection({ title, description, buttonText, buttonUrl, backgroundColor, textColor, alignment, }: CTASectionProps): react_jsx_runtime.JSX.Element;
interface DividerProps {
    style?: 'line' | 'dots' | 'gradient';
    spacing?: 'small' | 'medium' | 'large';
    color?: string;
}
declare function Divider({ style, spacing, color, }: DividerProps): react_jsx_runtime.JSX.Element;
...
declare function AuthorBio({ name, bio, avatarUrl, twitterUrl, linkedinUrl, websiteUrl, }: AuthorBioProps): react_jsx_runtime.JSX.Element;
...
declare function SocialShare({ title, showCounts, platforms, alignment, }: SocialShareProps): react_jsx_runtime.JSX.Element;
...
declare function CodeBlock({ code, language, showLineNumbers, title, }: CodeBlockProps): react_jsx_runtime.JSX.Element;
interface EmbedBlockProps {
    url: string;
    type?: 'youtube' | 'vimeo' | 'twitter' | 'custom';
    aspectRatio?: '16:9' | '4:3' | '1:1';
}
declare function EmbedBlock({ url, type, aspectRatio, }: EmbedBlockProps): react_jsx_runtime.JSX.Element;
...
declare function TwoColumnLayout({ leftContent, rightContent, leftWidth, gap, verticalAlign, }: TwoColumnLayoutProps): react_jsx_runtime.JSX.Element;
...
declare const blogPuckConfig: Config<BlogComponents>;
...
export { AccountOverview, type AccountOverviewProps, ActionButton, type ActionButtonProps, ActivityWidget, type ActivityWidgetProps, AddressCard, type AddressCardProps, AlertBox, type AlertBoxProps, AnnouncementBar, type AnnouncementBarProps, AuthorBio, type AuthorBioProps, type BlogComponents, CTASection, type CTASectionProps, CardContainer, type CardContainerProps, ChartWidget, type ChartWidgetProps, CheckoutSection, type CheckoutSectionProps, CodeBlock, type CodeBlockProps, type DashboardComponents, Divider, type DividerProps, type EcommerceComponents, EmailButton, type EmailButtonProps, EmailCard, type EmailCardProps, EmailColumns, type EmailColumnsProps, type EmailComponents, EmailContainer, type EmailContainerProps, EmailCoupon, type EmailCouponProps, EmailDivider, type EmailDividerProps, EmailFooter, type EmailFooterProps, EmailHeader, type EmailHeaderProps, EmailHero, type EmailHeroProps, EmailImage, type EmailImageProps, EmailList, type EmailListProps, EmailProduct, type EmailProductProps, EmailSpacer, type EmailSpacerProps, EmailText, type EmailTextProps, EmbedBlock, type EmbedBlockProps, type FeatureItem, FeatureList, type FeatureListProps, Footer, type FooterColumn, type FooterProps, FormSection, type FormSectionProps, GridLayout, type GridLayoutProps, Header, type HeaderProps, HeroSection, type HeroSectionProps, ImageBlock, type ImageBlockProps, ImageGallery, type ImageGalleryProps, type LayoutComponents, LoyaltyPointsWidget, type LoyaltyPointsWidgetProps, type NavLink, OrderHistoryList, type OrderHistoryListProps, OrderSummary, OrderSummaryCard, type OrderSummaryCardProps, type OrderSummaryItem, type OrderSummaryProps, PageHeader, type PageHeaderProps, PaymentMethodsList, type PaymentMethodsListProps, type PluginUIComponents, type PricingPlanItem, PricingTable, type PricingTableProps, ProductCard, type ProductCardProps, ProductGrid, type ProductGridItem, type ProductGridProps, QuickActionsGrid, type QuickActionsGridProps, QuoteBlock, type QuoteBlockProps, SelectField, type SelectFieldProps, ShippingTracker, type ShippingTrackerProps, type SocialLink, SocialShare, type SocialShareProps, StatWidget, type StatWidgetProps, SupportWidget, type SupportWidgetProps, TableWidget, type TableWidgetProps, TabsContainer, type TabsContainerProps, Testimonial, type TestimonialProps, TextBlock, type TextBlockProps, TextInputField, type TextInputFieldProps, ToggleField, type ToggleFieldProps, TwoColumnLayout, type TwoColumnLayoutProps, WishlistItem, type WishlistItemProps, blogPuckConfig, dashboardPuckConfig, ecommercePuckConfig, emailPuckConfig, layoutPuckConfig, pluginUIPuckConfig };
