 ...
 * Dashboard Puck Page
 *
 * Renders Puck-managed pages within the dashboard area.
...
export default async function DashboardPuckPage({ params }: PageProps) {
  const { slug } = await params;
  const fullSlug = `dashboard/pages/${slug.join('/')}`;
