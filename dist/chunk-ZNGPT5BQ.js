...
async function getNodemailer() {
  if (!nodemailer) {
    try {
      nodemailer = await Promise.resolve().then(() => _interopRequireWildcard(require("nodemailer")));
    } catch (e) {
...
var SmtpProvider = class {
  ...
  async sendBulk(message) {
    ...
    for (const recipient of message.recipients) {
      const result = await this.send(_chunkHY7GTCJMjs.__spreadProps.call(void 0, _chunkHY7GTCJMjs.__spreadValues.call(void 0, {}, message), {
        to: recipient.to,
        metadata: _chunkHY7GTCJMjs.__spreadValues.call(void 0, _chunkHY7GTCJMjs.__spreadValues.call(void 0, {}, message.metadata), recipient.metadata)
      }));
      results.push({
  ...
  async send(message) {
    ...
    try {
      ...
      if (message.campaignId || message.recipientId) {
        request.custom_args = _chunkHY7GTCJMjs.__spreadValues.call(void 0, _chunkHY7GTCJMjs.__spreadValues.call(void 0, _chunkHY7GTCJMjs.__spreadValues.call(void 0, {}, request.custom_args), message.campaignId && { campaign_id: message.campaignId }), message.recipientId && { recipient_id: message.recipientId });
      }
  ...
  async sendBulk(message) {
    ...
    try {
      ...
      for (let i = 0; i < message.recipients.length; i += batchSize) {
        ...
        for (const recipient of batch) {
          recipientVariables[recipient.to.email] = _chunkHY7GTCJMjs.__spreadValues.call(void 0, _chunkHY7GTCJMjs.__spreadValues.call(void 0, {}, recipient.substitutions), recipient.metadata);
        }
...
${canonicalRequestHashHex}`;
  ...
  return _chunkHY7GTCJMjs.__spreadProps.call(void 0, _chunkHY7GTCJMjs.__spreadValues.call(void 0, {}, headers), {
    "X-Amz-Date": amzDate,
...
function processLoops(template, data) {
  ...
  return template.replace(eachRegex, (_, arrayPath, content) => {
    ...
    return items.map((item, index) => {
      const itemData = _chunkHY7GTCJMjs.__spreadProps.call(void 0, _chunkHY7GTCJMjs.__spreadValues.call(void 0, {}, data), {
        "@index": index,
        "@first": index === 0,
...
function getEncryptionKey() {
  ...
  if (!key) {
    ...
    return _crypto.scryptSync.call(void 0, "development-fallback-key", "salt", KEY_LENGTH);
  }
  if (key.length === 64) {
    return Buffer.from(key, "hex");
  }
  return _crypto.scryptSync.call(void 0, key, "nextjs-cms-salt", KEY_LENGTH);
}
function encrypt(plaintext) {
  const key = getEncryptionKey();
  const iv = _crypto.randomBytes.call(void 0, IV_LENGTH);
  const salt = _crypto.randomBytes.call(void 0, SALT_LENGTH);
  const derivedKey = _crypto.scryptSync.call(void 0, key, salt, KEY_LENGTH);
  const cipher = _crypto.createCipheriv.call(void 0, ALGORITHM, derivedKey, iv);
...
function decrypt(encryptedData) {
  ...
  const derivedKey = _crypto.scryptSync.call(void 0, key, salt, KEY_LENGTH);
  const decipher = _crypto.createDecipheriv.call(void 0, ALGORITHM, derivedKey, iv);
...
function hash(value) {
  const salt = _crypto.randomBytes.call(void 0, 16).toString("hex");
  const hashed = _crypto.scryptSync.call(void 0, value, salt, 64).toString("hex");
  return `${salt}:${hashed}`;
}
...
async function getSettings(group, defaults) {
  ...
  const settings = _chunkHY7GTCJMjs.__spreadValues.call(void 0, {}, defaults);
...
function getEnvVarStatus() {
  return REQUIRED_ENV_VARS.map((envVar) => _chunkHY7GTCJMjs.__spreadProps.call(void 0, _chunkHY7GTCJMjs.__spreadValues.call(void 0, {}, envVar), {
...
async function getAllSettings() {
  ...
  return {
    branding,
    general,
    email: _chunkHY7GTCJMjs.__spreadProps.call(void 0, _chunkHY7GTCJMjs.__spreadValues.call(void 0, {}, email), {
    ...
    storage: _chunkHY7GTCJMjs.__spreadProps.call(void 0, _chunkHY7GTCJMjs.__spreadValues.call(void 0, {}, storage), {
      secretAccessKey: storage.secretAccessKey ? "********" : void 0
    }),
    ai: _chunkHY7GTCJMjs.__spreadProps.call(void 0, _chunkHY7GTCJMjs.__spreadValues.call(void 0, {}, ai), {
...
function createOpenTrackingUrl(recipientId, campaignId) {
  const params = new URLSearchParams(_chunkHY7GTCJMjs.__spreadValues.call(void 0, {
    r: recipientId
...
function createClickTrackingUrl(recipientId, originalUrl, linkId, campaignId) {
  const params = new URLSearchParams(_chunkHY7GTCJMjs.__spreadValues.call(void 0, _chunkHY7GTCJMjs.__spreadValues.call(void 0, {
    r: recipientId,
    u: originalUrl
...
async function recordEmailOpen(recipientId, metadata) {
  const now = /* @__PURE__ */ new Date();
  await _chunkH7VBPMCNjs.prisma.emailRecipient.update({
  ...
  if (metadata == null ? void 0 : metadata.campaignId) {
    await _chunkH7VBPMCNjs.prisma.emailCampaign.update({
  ...
  await _chunkH7VBPMCNjs.prisma.$executeRaw`
...
async function recordEmailClick(recipientId, url, metadata) {
  ...
  if (metadata == null ? void 0 : metadata.linkId) {
    await _chunkH7VBPMCNjs.prisma.emailLinkClick.create({
      data: {
    ...
    await _chunkH7VBPMCNjs.prisma.emailLink.update({
...
async function getOrCreateTrackedLink(campaignId, targetUrl) {
  let link = await _chunkH7VBPMCNjs.prisma.emailLink.findFirst({
    where: {
      campaignId,
      url: targetUrl
    }
  ...
  if (!link) {
    link = await _chunkH7VBPMCNjs.prisma.emailLink.create({
      data: {
        campaignId,
        url: targetUrl,
        clickCount: 0
...
async function handleBounce(event) {
  ...
  await _chunkH7VBPMCNjs.prisma.emailSubscriber.updateMany({
  ...
  if (event.recipientId) {
    ...
    await _chunkH7VBPMCNjs.prisma.emailRecipient.updateMany({
      where: {
        email: event.email,
...
function verifySendGridWebhook(payload, signature, timestamp, publicKey) {
  try {
    ...
    const verify = _crypto2.default.createVerify("sha256");
...
function verifyMailgunWebhook(timestamp, token, signature, apiKey) {
  const hmac = _crypto2.default.createHmac("sha256", apiKey);
  hmac.update(timestamp + token);
  const expected = hmac.digest("hex");
  return _crypto2.default.timingSafeEqual(Buffer.from(signature), Buffer.from(expected));
}
function verifyResendWebhook(payload, signature, secret) {
  const hmac = _crypto2.default.createHmac("sha256", secret);
  hmac.update(payload);
  const expected = hmac.digest("hex");
  return _crypto2.default.timingSafeEqual(Buffer.from(signature), Buffer.from(expected));
}
...
async function subscribeEmail(email, options = {}) {
  ...
  try {
    const existing = await _chunkH7VBPMCNjs.prisma.emailSubscriber.findUnique({
    ...
    if (existing) {
      ...
      if (["UNSUBSCRIBED", "CLEANED"].includes(existing.status)) {
        ...
        const updated = await _chunkH7VBPMCNjs.prisma.emailSubscriber.update({
          where: { email: normalizedEmail },
          data: {
    ...
    const subscriber = await _chunkH7VBPMCNjs.prisma.emailSubscriber.create({
      data: {
...
async function confirmSubscription(token) {
  try {
    const subscriber = await _chunkH7VBPMCNjs.prisma.emailSubscriber.findUnique({
...
async function unsubscribeEmail(email, options = {}) {
  ...
  try {
    ...
    await _chunkH7VBPMCNjs.prisma.emailSubscriber.update({
      where: { email: normalizedEmail },
      data: {
        status: "UNSUBSCRIBED",
        unsubscribedAt: /* @__PURE__ */ new Date(),
        metadata: _chunkHY7GTCJMjs.__spreadProps.call(void 0, _chunkHY7GTCJMjs.__spreadValues.call(void 0, {}, subscriber.metadata || {}), {
...
async function getSubscriberPreferences(subscriberIdOrEmail) {
  try {
    let subscriber = await _chunkH7VBPMCNjs.prisma.emailSubscriber.findUnique({
      where: { id: subscriberIdOrEmail }
    });
    if (!subscriber) {
      subscriber = await _chunkH7VBPMCNjs.prisma.emailSubscriber.findUnique({
  ...
  try {
    ...
    const updated = await _chunkH7VBPMCNjs.prisma.emailSubscriber.update({
      ...
      data: {
        ...
        preferences: _chunkHY7GTCJMjs.__spreadValues.call(void 0, _chunkHY7GTCJMjs.__spreadValues.call(void 0, {}, currentPrefs), preferences.emailPreferences)
      }
    });
    return { success: true, subscriber: updated };
  } catch (error) {
...
async function sendConfirmationEmail(email, token) {
  const { sendEmail: sendEmail2 } = await Promise.resolve().then(() => _interopRequireWildcard(require("./email-CGROEZP6.js")));
...
var EmailQueue = class {
  ...
  async persistEmail(email) {
    try {
      await _chunkH7VBPMCNjs.prisma.emailQueueItem.create({
        data: {
          id: email.id,
  ...
  async updatePersistedEmail(email) {
    try {
      await _chunkH7VBPMCNjs.prisma.emailQueueItem.update({
        where: { id: email.id },
        data: {
          status: email.status,
          attempts: email.attempts,
  ...
  async loadFromDatabase() {
    ...
    try {
      const items = await _chunkH7VBPMCNjs.prisma.emailQueueItem.findMany({
        where: {
...
async function queueUrgentEmail(message, options) {
  return queueEmail(message, _chunkHY7GTCJMjs.__spreadProps.call(void 0, _chunkHY7GTCJMjs.__spreadValues.call(void 0, {}, options), { priority: "high" }));
}
async function scheduleEmail(message, sendAt, options) {
  return queueEmail(message, _chunkHY7GTCJMjs.__spreadProps.call(void 0, _chunkHY7GTCJMjs.__spreadValues.call(void 0, {}, options), { scheduledFor: sendAt }));
}
...
var EmailService = class {
  ...
  initWithConfig(providerType, providerConfig, serviceConfig) {
    ...
    this.config = _chunkHY7GTCJMjs.__spreadValues.call(void 0, {
  ...
  async sendWithMergeTags(message, data) {
    ...
    return this.send(_chunkHY7GTCJMjs.__spreadProps.call(void 0, _chunkHY7GTCJMjs.__spreadValues.call(void 0, {}, message), {
      subject,
      html,
      text
    }));
  ...
  async sendBulk(message) {
    ...
    let totalFailed = 0;
    for (const recipient of message.recipients) {
      const result = await provider.send(_chunkHY7GTCJMjs.__spreadProps.call(void 0, _chunkHY7GTCJMjs.__spreadValues.call(void 0, {}, message), {
        to: recipient.to,
        metadata: _chunkHY7GTCJMjs.__spreadValues.call(void 0, _chunkHY7GTCJMjs.__spreadValues.call(void 0, {}, message.metadata), recipient.metadata)
      }));
      results.push({
...
exports.parseMergeTags = parseMergeTags; exports.extractMergeTags = extractMergeTags; exports.validateMergeTagData = validateMergeTagData; exports.registerFormatter = registerFormatter; exports.getFormatters = getFormatters; exports.encrypt = encrypt; exports.decrypt = decrypt; exports.isEncrypted = isEncrypted; exports.safeEncrypt = safeEncrypt; exports.safeDecrypt = safeDecrypt; exports.hash = hash; exports.verifyHash = verifyHash; exports.DEFAULT_BRANDING_SETTINGS = DEFAULT_BRANDING_SETTINGS; exports.DEFAULT_GENERAL_SETTINGS = DEFAULT_GENERAL_SETTINGS; exports.DEFAULT_EMAIL_SETTINGS = DEFAULT_EMAIL_SETTINGS; exports.DEFAULT_STORAGE_SETTINGS = DEFAULT_STORAGE_SETTINGS; exports.DEFAULT_AI_SETTINGS = DEFAULT_AI_SETTINGS; exports.DEFAULT_SECURITY_SETTINGS = DEFAULT_SECURITY_SETTINGS; exports.REQUIRED_ENV_VARS = REQUIRED_ENV_VARS; exports.getSettings = getSettings; exports.updateSettings = updateSettings; exports.clearSettingsCache = clearSettingsCache; exports.getBrandingSettings = getBrandingSettings; exports.getGeneralSettings = getGeneralSettings; exports.getEmailSettings = getEmailSettings; exports.getStorageSettings = getStorageSettings; exports.getAiSettings = getAiSettings; exports.getSecuritySettings = getSecuritySettings; exports.getEnvVarStatus = getEnvVarStatus; exports.getAllSettings = getAllSettings; exports.generateTrackingToken = generateTrackingToken; exports.createOpenTrackingUrl = createOpenTrackingUrl; exports.createClickTrackingUrl = createClickTrackingUrl; exports.createUnsubscribeUrl = createUnsubscribeUrl; exports.createPreferenceCenterUrl = createPreferenceCenterUrl; exports.injectOpenTrackingPixel = injectOpenTrackingPixel; exports.rewriteLinksForTracking = rewriteLinksForTracking; exports.getUnsubscribeHeaders = getUnsubscribeHeaders; exports.processEmailForTracking = processEmailForTracking; exports.recordEmailOpen = recordEmailOpen; exports.recordEmailClick = recordEmailClick; exports.getOrCreateTrackedLink = getOrCreateTrackedLink; exports.rewriteLinksWithTracking = rewriteLinksWithTracking; exports.processEmailWebhookEvent = processEmailWebhookEvent; exports.parseSendGridWebhook = parseSendGridWebhook; exports.parseMailgunWebhook = parseMailgunWebhook; exports.parseResendWebhook = parseResendWebhook; exports.parseSesWebhook = parseSesWebhook; exports.verifySendGridWebhook = verifySendGridWebhook; exports.verifyMailgunWebhook = verifyMailgunWebhook; exports.verifyResendWebhook = verifyResendWebhook; exports.generateSubscriptionToken = generateSubscriptionToken; exports.verifySubscriptionToken = verifySubscriptionToken; exports.subscribeEmail = subscribeEmail; exports.confirmSubscription = confirmSubscription; exports.unsubscribeEmail = unsubscribeEmail; exports.unsubscribeById = unsubscribeById; exports.getSubscriberPreferences = getSubscriberPreferences; exports.updateSubscriberPreferences = updateSubscriberPreferences; exports.addSubscriberTags = addSubscriberTags; exports.removeSubscriberTags = removeSubscriberTags; exports.EmailQueue = EmailQueue; exports.getEmailQueue = getEmailQueue; exports.queueEmail = queueEmail; exports.queueEmails = queueEmails; exports.queueUrgentEmail = queueUrgentEmail; exports.scheduleEmail = scheduleEmail; exports.getQueueStats = getQueueStats; exports.checkEmailStatus = checkEmailStatus; exports.EmailService = EmailService; exports.emailService = emailService; exports.sendEmail = sendEmail; exports.sendBulkEmail = sendBulkEmail2; exports.sendEmailWithMergeTags = sendEmailWithMergeTags;
//# sourceMappingURL=chunk-ZNGPT5BQ.js.map